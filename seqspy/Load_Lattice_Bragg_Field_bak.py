...
ir1.appendhold( fval('ir1delay1') )
ir2.appendhold( fval('ir2delay1') )
ir3.appendhold( fval('ir3delay1') )
ir1.linear(fval('ir1pow1'),fval('ir1rampdt1'))
ir2.linear(fval('ir2pow1'),fval('ir2rampdt1'))
ir3.linear(fval('ir3pow1'),fval('ir3rampdt1'))
...
intermediate_dt = max( fval('gr1delay1') + fval('gr1rampdt1'), \
                    fval('gr2delay1') + fval('gr2rampdt1'), \
                    fval('gr3delay1') + fval('gr3rampdt1'), \
                    fval('ir1delay1') + fval('ir1rampdt1'), \
                    fval('ir2delay1') + fval('ir2rampdt1'), \
                    fval('ir2delay1') + fval('ir2rampdt1'), \
...
if inlattice < separate_ramps_cuttof:
	...
	ir1  = wfm.wave('ir1pow', ir1pow2, ir_ss)
	ir2  = wfm.wave('ir2pow', ir2pow2, ir_ss)
	ir3  = wfm.wave('ir3pow', ir3pow2, ir_ss)
...
if camera == 'andor':
	...
	s.digichg('greenttl1',latticeon_picture*float(report['LATTICEBRAGGFIELD']['gr1']) )
	s.digichg('greenttl2',latticeon_picture*float(report['LATTICEBRAGGFIELD']['gr1']) )
	s.digichg('greenttl3',latticeon_picture*float(report['LATTICEBRAGGFIELD']['gr3']) )
	s.digichg('irttl1',latticeon_picture*float(report['LATTICEBRAGGFIELD']['ir1']) )
	s.digichg('irttl2',latticeon_picture*float(report['LATTICEBRAGGFIELD']['ir2']) )
	s.digichg('irttl3',latticeon_picture*float(report['LATTICEBRAGGFIELD']['ir3']) )
	s.wait(20.0)
