...
lcr1.linear(lbf.lcr1s1,lbf.lcr1rampdt1)
lcr2.linear(lbf.lcr2s1,lbf.lcr2rampdt1)
lcr3.linear(lbf.lcr3s1,lbf.lcr3rampdt1)
...
lcr1.linear(lbf.lcr1s1,lbf.lcr1rampdt2)
lcr2.linear(lbf.lcr2s1,lbf.lcr2rampdt2)
lcr3.linear(lbf.lcr3s1,lbf.lcr3rampdt2)
