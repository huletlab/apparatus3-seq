...
ir1  = lattice.lattice_wave('ir1pow', 0., ir_ss,volt=-11)
ir2  = lattice.lattice_wave('ir2pow', 0., ir_ss,volt=-11)
ir3  = lattice.lattice_wave('ir3pow', 0., ir_ss,volt=-11)
...
gr1  = lattice.lattice_wave('greenpow1', 0., ir_ss)
gr2  = lattice.lattice_wave('greenpow2', 0., ir_ss)
gr3  = lattice.lattice_wave('greenpow3', 0., ir_ss)
