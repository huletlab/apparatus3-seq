...
def ramps_dir():
	return lab+"software/apparatus3/seq/seqspy/sandbox/ramps/"
...
def savedir():
    return lab+'software/apparatus3/seq/seqspy/sandbox/'
...
def seqtxtout():
        return lab+'software/apparatus3/seq/seqspy/sandbox/expseq.txt'
