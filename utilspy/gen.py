...
#This function get lattice webcam data from: /lab/software/apparatus3/log/values/Lattice_Webcam/log.dat and save the data to the report
def get_lattice_webcam_data(input=""):
    logfile = seqconf.base_seqspypath().split("seq/")[0] +"log/values/Lattice_Webcam/log.dat"
...
def shutdown(s):
	...
	########### Avoid possible cross talk by adding 1ms wait between changes!######
	s.digichg('motswitch',0)
	s.wait(1.0)
	s.digichg('zsshutter',1)
	s.wait(1.0)
